package br.com.ferreira.config;
...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            cm.createCache(br.com.ferreira.repository.UserRepository.USERS_BY_LOGIN_CACHE, jcacheConfiguration);
            cm.createCache(br.com.ferreira.repository.UserRepository.USERS_BY_EMAIL_CACHE, jcacheConfiguration);
