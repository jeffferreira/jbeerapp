...
public class YeastResource {
    ...
    @PostMapping("/yeasts")
    @Timed
    public ResponseEntity<Yeast> createYeast(@RequestBody Yeast yeast) throws URISyntaxException {
    ...
    @PutMapping("/yeasts")
    @Timed
    public ResponseEntity<Yeast> updateYeast(@RequestBody Yeast yeast) throws URISyntaxException {
